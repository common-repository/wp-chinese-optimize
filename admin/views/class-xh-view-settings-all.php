...
class XH_WP_Optimize_View_Settings_All extends XH_WP_Optimize_View_Form_Native{
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td>
					<label><input type="checkbox" value="yes" name="XH_WP_OPTIMIZE_ALL[enabled_translate_cache]" <?php print (isset($this->options['enabled_translate_cache'])&&$this->options['enabled_translate_cache']=='yes'?'checked':'');?> /> 缓存翻译文件</label>
					<hr/>
					<p>加快翻译文件的加载(你必须启用memcached或redis等第三方缓存插件后才会生效)</p>
					</td>
				</tr>
			</tbody>
		</table>
