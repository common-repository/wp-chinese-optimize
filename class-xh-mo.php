<?php
if (! class_exists('XH_MO')) {

    class XH_MO extends Gettext_Translations
    {
        ...
        function import_from_reader($reader)
        {
            ...
            for ($i = 0; $i < $header['total']; $i ++) {
                ...
                if ('' === $original) {
                    $cached_data['headers'][]=$this->make_headers($translation);
                } else {
                     $cached_data['entries'][$original]=$translation;
                }
            }
